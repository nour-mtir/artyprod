...
from ArtyProd import models as CMODEL
from ArtyProd import forms as CFORM
...
from ArtyProd.models import Projet
...
def customer_dashboard_view(request):
    ...
    projects = Projet.objects.filter(customer=customer)
